...
export default function CourseCard({ course, isSaved, disableSaveBtn, selectedSchedule }) {
        ...
        <div className="group">
            ...
            >
                ...
                <div className="flex items-center p-1 gap-1">
                    ...
                    <div onClick={() => handleAddCourse(course, selectedSchedule)} className="cursor-pointer flex-col space-y-0.5 bg-green-100 hover:bg-green-200 text-green-800 flex items-center justify-center px-4 h-full w-20 rounded-xs rounded-r-md font-medium">
